...
namespace {
    ...
    const char BLACKLIST_PATH[] = "/config/RyazhTune/blacklist.ini";
    const char WHITELIST_PATH[] = "/config/RyazhTune/whitelist.ini";
    const char PLAYLIST_PATH[] = "/config/RyazhTune/playlist.txt";
    
    void create_config_dir() {
        ::sdmc::CreateFolder("/config");
        ::sdmc::CreateFolder("/config/RyazhTune");
    }
...
bool get_play_during_loading() {
    return ::ini_getbool("tune", "play_during_loading", false, CONFIG_PATH);
}

void set_play_during_loading(bool value) {
    create_config_dir();
    ::ini_putl("tune", "play_during_loading", value, CONFIG_PATH);
}

bool get_last_playing_state() {
    return ::ini_getbool("tune", "last_playing", false, CONFIG_PATH);
}

void set_last_playing_state(bool value) {
    create_config_dir();
    ::ini_putl("tune", "last_playing", value, CONFIG_PATH);
}
